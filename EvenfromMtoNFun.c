/*This is a C-Program to print all even numbers from m to n where m to n are two natural numbers input by the user. User defined function and while loop has been used in this program.*/
